...
<div class="row">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        $result = mysqli_query($conn, "SELECT * FROM business WHERE writer =  '".$writer_name."' order by id desc limit 1");
    ...
    <div id="nav-item">
            ...
            <div class="logout">
                <ul>
                    ...
                    <li><a href="index.html"><i class="fas fa-cogs lgo"></i>setting</a></li>
    ...
    <div class="col-lg-3">
        <div class="sidebar-area">
            <div class="sidebar-menu">
                ...
                $id=$row['id'];             
                ?>
                <li><a href="writer_business.php?bs_id=<?php echo $id; ?>" ><?php echo $row['name']?></a></li>
                <?php
                }
                ?>   
