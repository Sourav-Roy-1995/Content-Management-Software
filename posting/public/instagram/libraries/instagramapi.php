    ...
    class instagramapi{
        ...
        function sendSecurityCode($apiPath){
            try {
                ...
                if(is_array($sendSecurityCode)){
                    $sendSecurityCode = json_decode( json_encode($sendSecurityCode) );
                }
        ...
        function resendSecurityCode($apiPath){
            try {
                ...
                if(is_array($resendSecurityCode)){
                    $resendSecurityCode = json_decode( json_encode($resendSecurityCode) );
                }
