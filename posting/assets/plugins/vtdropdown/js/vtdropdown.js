		...
		_layout : function(){
			...
			this.el.children('option').each(function(index, value){
				var _this        = $( this ),
					...
					if(index > 0){
						listopts += "<li class='select-account-item' data-url='"+_actionUrl+"' data-ids='"+_value+"'><a href='javascript:void(0);'><span class='img' style='background-image: url("+_image+");background-size: 40px 40px;border-radius: 50%;'></span><span class='text'>"+_text+"</span></a></li>";
					}
			});
