...
<div class="schedules">
	<div class="row">
		<a href="javascript:void(0);" class="sc-toggle-open bg-primary"><i class="fa fa-filter" aria-hidden="true"></i></a>
				...
				<ul>
					...
					<li>
						<div class="pure-checkbox grey">
					        <input type="checkbox" name="social_filter[]" id="md_checkbox_<?=$row->title?>" class="filled-in chk-col-red sc-action" checked="" value="<?=$row->title?>">
