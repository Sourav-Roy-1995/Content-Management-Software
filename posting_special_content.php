<?php 
    include "auth/auth_posting.php";
    $posting_name =  $_SESSION["name"];
...
<div class="row">
    <div class="col-md-5 col-lg-4">
        ...
        <div class="logo">
            <figure>
                <a href="posting.php"><img src="images/logo.png" alt="" class="img-fluid">Business Management Console </a>
            </figure>
        </div><!--[/End logo]-->
    </div>
    <div class="col-md-7 col-lg-8">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM business WHERE posting =  '".$posting_name."' AND bs_status = '".$active."' order by id desc limit 1");
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="posting_business.php?bs_id=<?php echo $id; ?>">Business</a>
                    </li>
                    <?php                                  
                    }
                    ?>
        ...
        <div id="nav-item">
            <a class="nav-link dropdown" href=""><span>hello</span> <?php echo $posting_name; ?> <i class="fa fa-user user"></i></a>
            <div class="logout">
                <ul>
                   
                    <li><a href="#"><i class="fas fa-cogs lgo"></i>setting</a></li>
                    <li><a href="counter_posting.php"><i class="fas fa-calculator lgo"></i>Counter</a></li>
...
$(document).ready(function (){  
    var date = $('#date').val();
    var posting_name = $('#posting_name').val();
    var active = $('#active').val();

    if(date != '' && posting_name != '' && active != '')  
    {  
            $.ajax({  
                url:"filter_special_content_posting.php",  
                method:"POST",  
                data:{date:date,posting_name:posting_name,active:active},  
                success:function(data)  
                {  
