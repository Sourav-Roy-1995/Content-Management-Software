            ...
            <div class="row">
                    ...
                    <div class="sidebar-area">
                        <div class="sidebar-menu">
                            ...
                            <li id="<?php echo $row['id']; ?>">
                                <a href="#" class="sourcelink" id="bs-link" data-role="update" data-id="<?php echo $row['id'] ;?>" data-target="team_name"><?php echo $row['team_name']?></a>
                            </li>
                            <?php
                            }
                            ?>   
                ...
                <div class="col-lg-9" id="adduser">
                    <div class="content-update">
                        ...
                        <div class="add-user">
                            <h2>Add Team</h2>
                            <form action="add_team_system.php" method="POST" class="user-add">
                                ...
                                <div class="form-group">
                                     <input name="team_name" type="text" class="form-control" id="select"  required>
                                </div>
...
<div class="modal-body">
    ...
    <input type="hidden" id="teamId" class="form-control">
</div>
...
$.ajax({
    url      : 'edit_team.php',
    method   : 'post', 
    data     : {team_name : team_name , id: id},
